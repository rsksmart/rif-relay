...
describe('AccountManager', function () {
  ...
  describe('#addAccount()', function () {
    it('should save the provided keypair internally', async function () {
      ...
      const accountManager = new AccountManager(ethers.provider, defaultEnvironment.chainId, config,
  ...
  describe('#sign()', function () {
    ...
    beforeEach(async function () {
      ...
      accountManager = new AccountManager(ethers.provider, defaultEnvironment.chainId, config,
        async (signedData: any): Promise<string> => {
          if (shouldThrow) {
            throw new Error('Fail of testing')
          }
