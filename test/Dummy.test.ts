...
contract(
    'GasEstimation',
    function ([_, relayOwner, relayManager, relayWorker]) {
        let env: Environment;
        let chainId: number;
        ...
        beforeEach(async function () {
            ...
            encodedFunctionDummy1 = dummy.contract.methods
                .stress(20)
                .encodeABI();
        });
                    ...
                    pushToResults(
                        {
                            ...
                            gasUsed: (result as TransactionReceipt).gasUsed,
                            cumulativeGasUsed: (result as TransactionReceipt)
                                .cumulativeGasUsed,
