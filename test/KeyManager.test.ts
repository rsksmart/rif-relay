...
contract('KeyManager', function () {
    describe('in-memory', () => {
        ...
        it('should return key', () => {
            ...
            // @ts-ignore
            assert.deepEqual(
                mkm._privateKeys[k0].toString('hex'),
        ...
        it('should return another key for different index', () => {
            ...
            // @ts-ignore
            assert.equal(
                mkm._privateKeys[k1].toString('hex'),
    ...
    describe('file-based KeyManager', () => {
        ...
        before('create key manager', function () {
            ...
            assert.isTrue(
                ...
                'test keystore dir should exist already'
            );
        });
        ...
        it('should get the same key when reloading', () => {
            ...
            // @ts-ignore
            assert.equal(
                fkmA._privateKeys[addrA].toString('hex'),
                fkmB._privateKeys[addrB].toString('hex')
            );
            ...
            // @ts-ignore
            assert.equal(
                fkmA._privateKeys[addrA10].toString('hex'),
                fkmB._privateKeys[addrB10].toString('hex')
            );
        });
