...
import EnvelopingRequest from './EnvelopingRequest'
...
export const EnvelopingRequestType = [
...
export default class EnvelopingTypedRequestData implements EIP712TypedData {
