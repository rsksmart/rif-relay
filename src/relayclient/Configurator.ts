...
//  * @param partialConfig
//  */
// export async function resolveConfiguration (provider: Jsonrpcprovider, partialConfig: Partial<EnvelopingConfig>): Promise<EnvelopingConfig> {
//   // @ts-ignore
...
//   ] = await Promise.all([
//     partialConfig.chainId ?? contractInteractor.getChainId(),
...
// export function getDependencies (config: EnvelopingConfig, provider?: providers.JsonRpcSigner, overrideDependencies?: Partial<EnvelopingDependencies>): EnvelopingDependencies {
